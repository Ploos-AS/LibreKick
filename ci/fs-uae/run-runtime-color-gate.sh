...
# Give the tiny ROM probe time to reach its stable PASS/FAIL loop.
sleep 2
...
# Ignore a small border and score the framebuffer by dominant diagnostic color.
...
# LibreKick's runtime probes intentionally fill the visible framebuffer with
