...
handoff=data[0x5900:0x5A00]
resume=data[0x5A00:0x5B00]
...
assert bytes.fromhex('2F3C00F85A00') in handoff, 'missing private resume-PC push'
...
assert bytes.fromhex('4EB900F85900') in probe, 'missing integrated context handoff call'
