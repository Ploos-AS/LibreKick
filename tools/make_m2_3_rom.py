...
ADDHEAD_FUNC_OFF = 0x380
REMHEAD_FUNC_OFF = 0x3C0
ADDHEAD_FUNC = ROM_BASE + ADDHEAD_FUNC_OFF
REMHEAD_FUNC = ROM_BASE + REMHEAD_FUNC_OFF
...
def build():
    ...
    image[ADDHEAD_FUNC_OFF:ADDHEAD_FUNC_OFF + len(addhead)] = addhead

    remhead = bytes.fromhex(
        "2F012F082F09201022402211670A208122412348000460027000225F205F221F4E75"
    )
    image[REMHEAD_FUNC_OFF:REMHEAD_FUNC_OFF + len(remhead)] = remhead
